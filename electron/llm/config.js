...
exports.LLM_MAX_TOKENS = Number((_d = process.env.ONLYJOBS_MAX_TOKENS) !== null && _d !== void 0 ? _d : 128); // Reduced for speed
// Ultra-fast Stage 1 configuration
exports.STAGE1_MAX_TOKENS = Number((_e = process.env.ONLYJOBS_STAGE1_MAX_TOKENS) !== null && _e !== void 0 ? _e : 32); // Minimal for classification
...
exports.STAGE1_TIMEOUT = Number((_k = process.env.ONLYJOBS_STAGE1_TIMEOUT) !== null && _k !== void 0 ? _k : 8000); // 8 second max for Stage 1
exports.STAGE2_TIMEOUT = Number((_l = process.env.ONLYJOBS_STAGE2_TIMEOUT) !== null && _l !== void 0 ? _l : 12000); // 12 second max for Stage 2
exports.IPC_TIMEOUT = Number((_m = process.env.ONLYJOBS_IPC_TIMEOUT) !== null && _m !== void 0 ? _m : 10000); // 10 second IPC wrapper
exports.FALLBACK_THRESHOLD = Number((_o = process.env.ONLYJOBS_FALLBACK_MS) !== null && _o !== void 0 ? _o : 6000); // Fallback after 6s
