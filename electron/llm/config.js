...
exports.ONLYJOBS_MAX_TOKENS = parseInt(process.env.ONLYJOBS_MAX_TOKENS || '128', 10);
exports.ONLYJOBS_CTX = parseInt(process.env.ONLYJOBS_CTX || '1024', 10);
exports.ONLYJOBS_N_GPU_LAYERS = parseInt(process.env.ONLYJOBS_N_GPU_LAYERS || '0', 10);
exports.ONLYJOBS_MODEL_NAME = process.env.ONLYJOBS_MODEL_NAME || 'Llama-3.2-3B Q4_K_M';
// Performance and reliability settings
exports.ONLYJOBS_INFER_TIMEOUT_MS = parseInt(process.env.ONLYJOBS_INFER_TIMEOUT_MS || '8000', 10);
