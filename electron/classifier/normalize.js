...
exports.normalizeResult = void 0;
...
function parseFrom(fromAddress) {
    ...
    if (match) {
        return {
            fromDisplay: safeTrim(match[1]).replace(/^["']|["']$/g, ''),
...
function normalizeResult(input, llm) {
    ...
    if (statusFromSubject && statusFromSubject !== llm.status) {
        result.status = statusFromSubject;
